...
import bannerImage from "../../assets/pictures/banner2.jpg";
import "./Landing.scss";
      ...
      <div className="landing-container">
        ...
        <div className="services-info">
          ...
          <div className="services-category">
            <div className="service-card service-info-one">
              ...
              <p>
                Streamline your job search with instant applications. With just
                a click, apply to multiple opportunities without the hassle of
            ...
            <div className="service-card service-info-three">
              ...
              <p>
                ...
                goodbye to endless resume tweaks – one profile connects you to
                all relevant jobs, reducing stress and saving time.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="about-us-container">
          ...
          <div className="about-us-content">
            <p>
              At <span className="company-name">Career Connect</span>, we
              believe in bridging the gap between talented professionals and the
              opportunities they deserve. Founded with a vision to simplify the
              job search process, our platform is designed to connect job
              seekers with top employers across various industries. Whether
              you’re a fresh graduate looking for your first opportunity or a
              seasoned professional seeking your next big move,
            ...
            <p>
              ...
              <span className="buzzword">transparency</span>, we are committed
              to helping you navigate the competitive job market with
              confidence.{"\n"}
            </p>
            <p>
              For employers,{" "}
              <span className="company-name">Career Connect</span> offers a
              seamless recruitment experience, providing access to a diverse
              pool of qualified candidates. We understand the challenges of
              finding the right fit, which is why we’ve built advanced tools to
